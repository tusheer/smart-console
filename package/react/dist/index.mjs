...
`;function ie(e){return typeof window!="undefined"&&Number(localStorage.getItem(`smart-devtool-resize-${e}`))||null}function ne({position:e}){let[t,o]=useState(ie(e)),[r,p]=useState(!1),d=useRef(null),s=useCallback(()=>{p(!0);},[]),a=useCallback(()=>{p(!1);},[]),m=useCallback(i=>{r&&o(e==="vertical"?i.pageY:i.pageX);},[r]),f=()=>({onMouseDown:s,ref:d});return useEffect(()=>{let i;return r&&(window.addEventListener("mousemove",m),window.addEventListener("mouseup",a)),i=setTimeout(()=>{localStorage.setItem(`smart-devtool-resize-${e}`,String(t===null?"":t));},700),()=>{window.removeEventListener("mousemove",m),window.removeEventListener("mouseup",a),clearTimeout(i);}},[r]),{mouseMove:t,getResizeProps:f}}var x=ne;var se=e=>typeof e,ae=({log:e,onSelect:t})=>(console.log(se(e.data)),jsxs(W,{onClick:t(e),children:[jsx(B,{status:e.type,children:e.type}),jsxs(H,{children:[JSON.stringify(e.data),jsxs(F,{children:[jsx("svg",{fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",children:jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"})}),e.time.toLocaleTimeString("en-US",{hour12:!0,formatMatcher:"best fit"})]})]})]})),N=ae;var pe=()=>{let[e,t]=useState(!0),o=k(i=>i.logs),[r,p]=useState(null),{mouseMove:d,getResizeProps:s}=x({position:"vertical"}),{mouseMove:a,getResizeProps:m}=x({position:"horizontal"});useEffect(()=>{t(!1);},[]);let f=i=>()=>p(i);return e?null:jsx(M,{children:jsxs(C,{varticalHeight:d,children:[jsx(V,l({},s())),jsxs(D,{children:[jsx(E,{"data-testid":"ul",children:o.map((i,j)=>jsx(N,{log:i,onSelect:f},j))}),r?jsxs(I,{horizontalWidth:a,children:[jsx($,l({},m())),JSON.stringify(r)]}):null]})]})})},ce=pe;var u,T,w=class{constructor(){R(this,u);}log(t){h(this,u,T).call(this,t,"log");}error(t){h(this,u,T).call(this,t,"error");}};u=new WeakSet,T=function(t,o){g.setState(r=>({logs:[...r.logs,{data:t,time:new Date,type:o}]}));};var U=new w;var Je=U;
