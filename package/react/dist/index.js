...
var C={color:{primary:"#161b22","grey:300":"#f2f2f2f2"}},L=t=>jsxRuntime.jsx(react$1.ThemeProvider,{theme:C,children:t.children}),l=L;var c={logs:[]},k=t=>{let e=t,a=()=>e,o=new Set;return {getState:a,setState:i=>{e={...e,...i(e)},o.forEach(b=>b());},subscribe:i=>(o.add(i),()=>o.delete(i))}},r=k(c),d=t=>react.useSyncExternalStore(r.subscribe,react.useCallback(()=>t(r.getState()),[]),()=>t(c));var m=s.div`
